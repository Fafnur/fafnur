import { getRoute, PATHS, toPath, withNavigationRoutes } from './navigation';
...
describe('withNavigationRoutes', () => {
  it('should strip leading slash from path', () => {
    const routes = [{ path: '/about' as any }];
